...
from svm import X_train, y_train, X_test, y_test
...
def evaluate(individual):
    ...
    ann.fit(X_tr_sub, y_tr)
    y_pred = ann.predict(X_val_sub)
...
print("Selected Features:", sum(mask))
...
y_pred = ann.predict(X_test_sel)

print("\n==== MODEL METRICS (ANN After GA) ====")
...
plt.ylabel("Actual")
plt.title("Confusion Matrix - ANN (After GA)")
plt.show()
